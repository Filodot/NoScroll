...
Статус версии `0.8.0`: EDU-01…EDU-11 реализованы. Ручной device smoke-test остаётся
обязательной проверкой на конкретной модели телефона перед публичным распространением.
