...
private const val AccessibilityDisclosure =
    "Чтобы распознавать Shorts и показывать паузу, NoScrol получает события интерфейса " +
        "только от приложения YouTube. Сервис может видеть элементы активного экрана YouTube " +
        "и взаимодействовать с ним для показа блокирующего окна. Данные обрабатываются на " +
        "устройстве: NoScrol не сохраняет содержимое экрана, названия видео, историю просмотров " +
        "или введённый в YouTube текст и никуда их не отправляет."
