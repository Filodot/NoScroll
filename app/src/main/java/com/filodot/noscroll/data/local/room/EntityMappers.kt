...
fun DailyUsage.toEntity(): DailyUsageEntity = DailyUsageEntity(
    ...
    pinterestSeconds = pinterestSeconds,
    chromeSeconds = chromeSeconds,
...
fun GateCycle.toEntity(): GateCycleEntity = GateCycleEntity(
    ...
    youtubeUsedSeconds = youtubeUsedSeconds,
    youtubeEntryCooldownUntilEpochMillis = youtubeEntryCooldownUntil?.toEpochMilli(),
    pinterestUsedSeconds = pinterestUsedSeconds,
    pinterestEntryCooldownUntilEpochMillis = pinterestEntryCooldownUntil?.toEpochMilli(),
    chromeUsedSeconds = chromeUsedSeconds,
    chromeEntryCooldownUntilEpochMillis = chromeEntryCooldownUntil?.toEpochMilli(),
...
fun GateCycleEntity.toModel(): GateCycle = GateCycle(
    ...
    youtubeUsedSeconds = youtubeUsedSeconds,
    youtubeEntryCooldownUntil = youtubeEntryCooldownUntilEpochMillis?.let(Instant::ofEpochMilli),
    pinterestUsedSeconds = pinterestUsedSeconds,
    pinterestEntryCooldownUntil =
        pinterestEntryCooldownUntilEpochMillis?.let(Instant::ofEpochMilli),
    chromeUsedSeconds = chromeUsedSeconds,
    chromeEntryCooldownUntil = chromeEntryCooldownUntilEpochMillis?.let(Instant::ofEpochMilli),
    difficultyLoadSeconds = difficultyLoadSeconds,
